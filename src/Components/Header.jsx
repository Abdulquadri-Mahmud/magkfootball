    ...
    <div className=" bg-blue-900 shadow-xl py-1">
        ...
        <div className='xl:max-w-[90%] mx-auto text-white px-4'>
            <div className='flex justify-between items-center'>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex item-center font-medium gap-1 py-1">
                        <Link to={'/'} className='py-1'>Log in</Link>
                        {/* <span>|</span> */}
                        <Link to={'/'} className='w-16 text-center uppercase bg-cyan-400 py-1 rounded-full'>Join</Link>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="pt-3">
            <div className="hidde md:block xl:max-w-[90%] mx-auto">
                <div className=" nav flex gap-7 font-medium justify-center items-center text-[15px] nav">
