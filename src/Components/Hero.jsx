  ...
  return (
    <div className='overflow-hidden md:px-0 px-6 md:h-[75vh] sm:h-[75vh] h-[85vh] hero bg-gradient-to-t from-blue-600 to-blue-950 flex justify-center items-center'>
      <div className="flex flex-wrap md:flex-row flex-col-reverse justify-around items-center w-full">
        ...
        <div className="md:w-[50%] md:text-start text-center w-full">
          ...
          <Slider {...settings}>
            ...
            <div className="">
              <div className="flex justify-center">
                <img src="/ball.webp" className='rounded-full animate-spin md:max-w-[300px] max-w-[280px] drop-shadow-2xl ball' alt="" />
              </div>
            </div>
