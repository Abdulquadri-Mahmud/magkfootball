        ...
        <div className="w-[100%] md:h-[220px] h-[200px] rounded-md flex justify-center items-center bg-gray-900 ">
          <div className="text-white">
            <div className="flex justify-center flex-col gap-1 items-center">
              <h1 className="text-6xl font-medium text-red-600">
                Bet<span className="text-green-600">9ja</span>
              </h1>
              <p className="text-2xl font-medium text-red-600">
                BES<span className="text-green-600">LIPS</span>
              </p>
              <p className="text-gray-500 text-sm text-center">
                Check out our reliable betslips
              </p>
            </div>
          </div>
        </div>
