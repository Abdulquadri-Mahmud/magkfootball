...
export default function Betano() {
  return (
    <div className='py-10 bg-zinc-100'>
        <div className="2xl:max-w-[80%] xl:max-w-[90%] lg:max-w-[100%] max-w-[97%] mx-auto">
            <div className="flex justify-center items-center">
                <h1 className='text-4xl font-medium text-orange-600'>BET<span className="text-green-600">NO</span></h1>       
                -<p className="text-4xl font-medium text-orange-600">BES<span className="text-green-600">LIPS</span></p>
            </div>
