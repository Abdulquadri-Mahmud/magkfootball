...
import { FaCrown, FaRegCopy, FaTrashAlt } from 'react-icons/fa';
        ...
        <div className="w-[100%] md:h-[220px] h-[200px] rounded-md flex justify-center items-center betking ">
            <div className="text-white">
                <div className="flex justify-center flex-col gap-1  items-center">
                    <h1 className='text-4xl  font-medium flex'>Bet <span className="relative"><FaCrown className='absolute -top-5 left-0 text-[26px] text-yellow-400'/><span>K</span></span>ing</h1>
                    <p className="text-4xl font-medium text-cyan-600">BET<span className="text-yellow-400">SLIPS</span></p>
